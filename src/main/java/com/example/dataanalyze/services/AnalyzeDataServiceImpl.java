...
public class AnalyzeDataServiceImpl implements AnalyzeDataService {
    ...
    public AnalyzeDataServiceImpl(SearchOutputDTOCreator outputForSearchProcessor, SearchCriteriaDTOCreator searchCriteriaDTOCreator, StatOutputDTOCreator statOutputDTOCreator, Writable writable) {
